  ...
  return (
    <span
      style={{
        ...
        fontSize: 12,
        fontWeight: 500,
        background: status.colour + "22",
        color: status.colour,
        border: `1px solid ${status.colour}44`,
      }}
    >
      {status.name}
    </span>
...
export default function InventoryPage() {
  ...
  const [addForm, setAddForm]     = useState({ sku: "", title: "", category_id: "", status_id: "", location_id: "" });
  ...
  async function handleAdd() {
    if (!addForm.sku.trim()) { setAddError("SKU is required"); return; }
    setSaving(true);
    setAddError("");
    ...
    setSaving(false);
    setShowAdd(false);
    setAddForm({ sku: "", title: "", category_id: "", status_id: "", location_id: "" });
        ...
        <div style={{ position: "relative", marginBottom: showFilters ? 12 : 0 }}>
          ...
          <input
            ...
            style={{
              ...
              border: "1px solid #E5E7EB", fontSize: 14, outline: "none", background: "#fff",
            }}
          />
          {search && (
        ...
        {showFilters && (
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
            <select
              ...
              style={{ padding: "8px 12px", borderRadius: 8, border: "1px solid #E5E7EB", fontSize: 13, background: "#fff", color: "#374151" }}
            >
            ...
            {hasFilters && (
              <button onClick={clearFilters} style={{ padding: "8px 12px", borderRadius: 8, border: "1px solid #E5E7EB", fontSize: 13, background: "#fff", color: "#EF4444", cursor: "pointer" }}>
                Clear all
              </button>
            )}
          </div>
          ...
          <tbody>
            {loading ? (
              ...
              <tr
                ...
                style={{
                  borderBottom: i < pieces.length - 1 ? "1px solid #F3F4F6" : "none",
                  cursor: "pointer",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 16 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              style={{ padding: "6px 14px", borderRadius: 8, border: "1px solid #E5E7EB", background: "#fff", fontSize: 13, cursor: page <= 1 ? "not-allowed" : "pointer", color: page <= 1 ? "#D1D5DB" : "#374151" }}
            >
              Prev
            </button>
            <button
              ...
              onClick={() => setPage(p => p + 1)}
              style={{ padding: "6px 14px", borderRadius: 8, border: "1px solid #E5E7EB", background: "#fff", fontSize: 13, cursor: page >= totalPages ? "not-allowed" : "pointer", color: page >= totalPages ? "#D1D5DB" : "#374151" }}
            >
              Next
            </button>
          </div>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
          <div style={{ background: "#fff", borderRadius: 16, padding: 32, width: "100%", maxWidth: 440, boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              <div>
                <label style={{ fontSize: 13, fontWeight: 500, color: "#374151", display: "block", marginBottom: 4 }}>SKU <span style={{ color: "#EF4444" }}>*</span></label>
                <input
                  value={addForm.sku}
              ...
              <div>
                <label style={{ fontSize: 13, fontWeight: 500, color: "#374151", display: "block", marginBottom: 4 }}>Status</label>
                <select
                  value={addForm.status_id}
                  onChange={e => setAddForm(f => ({ ...f, status_id: e.target.value }))}
                  style={{ width: "100%", padding: "9px 12px", borderRadius: 8, border: "1px solid #E5E7EB", fontSize: 14, background: "#fff" }}
                >
              ...
              <div>
                <label style={{ fontSize: 13, fontWeight: 500, color: "#374151", display: "block", marginBottom: 4 }}>Location</label>
                <select
            ...
            <div style={{ display: "flex", gap: 8, marginTop: 24 }}>
              <button
                ...
                style={{ flex: 1, padding: "10px", borderRadius: 8, border: "1px solid #E5E7EB", background: "#fff", fontSize: 14, cursor: "pointer", color: "#374151" }}
              >
                Cancel
              </button>
              <button
